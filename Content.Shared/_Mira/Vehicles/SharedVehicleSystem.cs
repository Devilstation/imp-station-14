...
public abstract partial class SharedVehicleSystem : EntitySystem
{
    ...
    private void OnSiren(EntityUid uid, VehicleComponent component, InstantActionEvent args)
    {
        ...
        {
            var result = _audio.PlayPvs(component.SirenSound, component.Owner, AudioParams.Default.WithLoop(true).WithMaxDistance(5));
            if (result.HasValue)
            {
                component.SirenStream = result.Value.Entity;
            }
